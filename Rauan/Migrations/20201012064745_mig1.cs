        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Name = table.Column<string>(nullable: true),
                    FirstInfo = table.Column<string>(nullable: true),
                    Price = table.Column<int>(nullable: true),
                    MinPay = table.Column<int>(nullable: true),
                    PublicImage = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BadText = table.Column<string>(nullable: true),
                    GoodText = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LateViews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LateViews_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LateViews_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    InfoName = table.Column<string>(nullable: true),
                    InfoValue = table.Column<string>(nullable: true),
                    ProductInfoId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InProductInfos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InProductInfos_ProductInfos_ProductInfoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InProductInfos_ProductInfoId",
                table: "InProductInfos",
                column: "ProductInfoId");

            migrationBuilder.CreateIndex(
                name: "IX_LateViews_ProductId",
                table: "LateViews",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_LateViews_UserId",
                table: "LateViews",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_Pod_CategoryId",
                table: "Products",
